      ...
      <main className="flex-1 py-12 md:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-6 text-center">
            {messages["aboutTitle"] || "About Gloria Local Connect"}
          </h1>
          ...
          <section className="mb-10">
            <h2 className="text-xl font-semibold mb-2 text-primary text-center">
              {messages["aboutMission"] || "Our Mission"}
            </h2>
            <p className="text-base text-center text-muted-foreground">
              {messages["aboutMissionText"] ||
                "To empower local businesses and residents by providing a platform for discovery, engagement, and support."}
            </p>
          </section>
          <section>
            <h2 className="text-xl font-semibold mb-2 text-primary text-center">
              {messages["aboutVision"] || "Our Vision"}
            </h2>
            <p className="text-base text-center text-muted-foreground">
              {messages["aboutVisionText"] ||
