...
import { emailSchema, formatZodErrors, loginPasswordSchema, loginSchema } from "@/lib/schemas";
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
          <form onSubmit={form.handleSubmit} className="p-6 md:p-8">
            <FieldGroup>
              <div className="flex flex-col items-center gap-2 text-center">
                <h1 className="text-2xl font-bold">Welcome back</h1>
                <p className="text-muted-foreground text-balance">
                  Login to your Gloria Local Connect account
                </p>
              </div>
              <form.Field
                name="email"
      ...
      <FieldDescription className="px-6 text-center">
        By clicking continue, you agree to our <Link href={`/${locale}/terms`}>Terms of Service</Link>{" "}
        and <Link href={`/${locale}/privacy`}>Privacy Policy</Link>.
      </FieldDescription>
    </div>
  );
}
